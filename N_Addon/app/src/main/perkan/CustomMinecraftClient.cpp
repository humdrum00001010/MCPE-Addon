...
void CustomMinecraftClient::leaveGame(MinecraftClient *thiz, bool join) {
	...
	Var::getHooker()->mobs.clear();
	Var::getHooker()->players.clear();
}

void CustomMinecraftClient::hook() {
	MSHookFunction(dlsym(RTLD_DEFAULT, "_ZN15MinecraftClientC2EiPPc"), (void *) &constructor,
	               (void **) &constructor_real);
	MSHookFunction(dlsym(RTLD_DEFAULT, "_ZN15MinecraftClientD2Ev"), (void *) &destructor,
	               (void **) &destructor_real);
	MSHookFunction(dlsym(RTLD_DEFAULT, "_ZN15MinecraftClient4initEv"), (void *) &init,
	               (void **) &init_real);
	MSHookFunction(dlsym(RTLD_DEFAULT, "_ZN15MinecraftClient14onPlayerLoadedER6Player"),
	               (void *) &onPlayerLoaded, (void **) &onPlayerLoaded_real);
	MSHookFunction(dlsym(RTLD_DEFAULT, "_ZN15MinecraftClient9leaveGameEb"),
	               (void *) &CustomMinecraftClient::leaveGame,
	               (void **) &CustomMinecraftClient::leaveGame_real);
}