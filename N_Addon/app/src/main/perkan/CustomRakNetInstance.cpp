...
void CustomRakNetInstance::hook() {
	MSHookFunction(
			dlsym(RTLD_DEFAULT, "_ZN14RakNetInstance7connectEN6Social18GameConnectionInfoES1_"),
			(void *) &CustomRakNetInstance::connect, (void **) &CustomRakNetInstance::connect_real);
}