...
public:
    static void(*connect_real)(RakNetInstance*, Social::GameConnectionInfo const&, Social::GameConnectionInfo const&);
    static void connect(RakNetInstance* thiz, Social::GameConnectionInfo const& myInfo, Social::GameConnectionInfo const& targetInfo);
    static void hook();
};
